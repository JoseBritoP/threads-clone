...
const UserCard = ({id,name,username,imgUrl,personType}:Props) => {
  ...
  return (
    <article className="flex flex-col justify-between gap-4 max-sm:rounded-xl max-xs:bg-slate-950 max-xs:p-4 sm:flex-row sm:items-center py-8 px-6 bg-[#111] rounded-lg ">
      <div className="flex flex-1 items-start justify-start gap-3 sm:items-center">
        ...
        <div className="flex-1 text-ellipsis">
          ...
          <h4 className="text-base font-semibold text-gray-500">@{username}</h4>
        </div>
      </div>
